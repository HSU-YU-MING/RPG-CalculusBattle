...
const STORY = {
  ...
  /* ================= 第一章 · 小考 ================= */
  ch1_intro: {
    chapter: 1, resetPrep: true, bg: "campus", img: "封面.png", speaker: "旁白",
    text: "九月，大一上學期。你抱著「微積分應該還好吧」的天真想法走進校園。\n你不知道的是——這堂課的死當率，是全系第一。",
    next: "ch1_alarm",
  },
  ch1_alarm: {
    chapter: 1, bg: "dorm", img: "鬧鐘_0.png", speaker: "鬧鐘",
  ...
  ch1_oversleep: {
    chapter: 1, bg: "dorm", img: "鬧鐘_0.png", speaker: "旁白",
    text: "等你睜開眼，已經中午 12 點。第一堂微積分，翹了。\n手機跳出同學阿哲的訊息：「欸教授說下週要小考耶，你死定了哈哈。」",
    next: "ch1_meet",
  },
  ch1_meet: {
    chapter: 1, bg: "campus", img: "封面.png", speaker: "阿哲",
  ...
  ch1_react: {
    ...
    cases: [
      { min: 75, speaker: "阿哲", img: "小考及格.png", text: "「欸你考超好的吧？教授還點名稱讚你！」\n你笑而不語——原來認真是有回報的。地基打穩了，期中就靠這股氣勢。" },
      { min: 50, speaker: "旁白", img: "小考_0.png", text: "小考成績普普，剛好踩在邊緣。教授發考卷時看了你一眼。\n還來得及，期中加把勁吧。" },
      { min: 0,  speaker: "微積分教授", img: "小考不及格.png", text: "「這位同學……下課後到我辦公室一下。」\n你的小考分數慘不忍睹。期中再這樣，這學期就危險了。" },
    ],
    next: "ch1_save",
  },
  ch1_save: {
  ...
  /* ================= 第二章 · 期中考 ================= */
  ch2_intro: {
    chapter: 2, resetPrep: true, bg: "campus", img: "封面.png", speaker: "旁白",
  ...
  /* ================= 第三章 · 期末考 ================= */
  ch3_intro: {
    chapter: 3, resetPrep: true, bg: "campus", img: "封面.png", speaker: "旁白",
  ...
  ch3_temple: {
    chapter: 3, bg: "campus", img: "拜文昌帝君.png", speaker: "阿哲",
  ...
  ch3_react: {
    ...
    cases: [
      { min: 75, speaker: "旁白", img: "期末考及格.png", text: "你放下筆，是全場前幾個寫完的。窗外的陽光好像特別溫暖。\n一學期的努力，答案就在這張考卷裡。" },
      { min: 50, speaker: "旁白", img: "期末_0.png", text: "鈴聲響起，你勉強寫完最後一題。\n結果如何，只能交給教授的紅筆了。" },
      { min: 0,  speaker: "旁白", img: "期末考不及格.png", text: "考卷上還有大片空白。你盯著時鐘，心一點一點往下沉。\n但無論如何，這學期，結束了。" },
    ],
    next: "ch3_end",
  },
  ch3_end: { type: "end" },
